...
const SpinnerLoader = () => {
  return (
    <div role="status">
      <svg
        aria-hidden="true"
        className="inline w-5 h-5 text-gray-600 animate-spin dark:text-gray-200 fill-gray-800"
        viewBox="0 0 100 101"
        fill="none"
