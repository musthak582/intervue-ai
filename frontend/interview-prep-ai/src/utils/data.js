export const CARD_BG = [
  ...
  { id: 4, bgcolor: 'linear-gradient(135deg, #fff2e9 0%, #fff7f0 100%)' },
  { id: 5, bgcolor: 'linear-gradient(135deg, #e7f6f6 0%, #f4fafd 100%)' },
  { id: 6, bgcolor: 'linear-gradient(135deg, #f5f5fc 0%, #fafafe 100%)' },
...
export const APP_FEATURES = [
  ...
  {
    id: "05",
    title: "Always Be Interview Ready",
    description:
      "Get frequent updates, personalized questions, and real-time tips to stay sharp and confident for any opportunity.",
  },
];
